...
void test() {
  ...
  while (1) {
    if (1) {
      // different members
      data[0].a = data[1].b + 1;
      data[1].b = data[2].c[0].a + 1;
      data[2].c[0].b = data[3].c[0].c + 1;
    }

    if (1) {
      // same member, different indexes
      data[1].c[0].b = data[0].c[0].b + data[0].c[0].b;
      data[0].c[0].b = data[1].c[0].b + 1;

      data[0].c[1].b = data[1].c[0].b + data[0].c[0].b;
      data[0].c[0].b = data[0].c[1].b + 1;
